...
const refreshSiteAppearance = () => {
    ...
    const updateAppearanceSectionsContent = () => {
        ...
        const introText = `
    Make yourself at home by changing the background colour being used by the pages on this site. Your browser uses its&apos; sandboxed &apos;Local Storage&apos; area to remember your changes between restarts.    
    `;
        /*
